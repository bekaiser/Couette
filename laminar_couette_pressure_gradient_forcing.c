...
main()
{
 ...
 dx = 0.000833333; // 0.0032 (Nx=30), 0.0017 (Nx=60), 0.00083333 (Nx=120)
      // Nx uniform internal nodes (m)
 dy = 0.00038462; // 0.0013 (Ny=3), 0.00071429 (Ny=6), 0.00038462 (Ny=12)
      // Ny uniform internal nodes (m)
 ...
 for(t=1; t<Nt; t++){ // Iteration loop
  ...
  Un = uVeln[60][6][t-1]; // Saved midpoint velocity value
  Unp1 = uVeln[60][6][t]; // Saved midpoint velocity value
